...
BaudRateSelect = A0001_Comp_02_ns.class_("BaudRateSelect", select.Select)
DistanceResolutionSelect = A0001_Comp_02_ns.class_("DistanceResolutionSelect", select.Select)
LightOutControlSelect = A0001_Comp_02_ns.class_("LightOutControlSelect", select.Select)
...
async def to_code(config):
    ...
    if baud_rate_config := config.get(CONF_BAUD_RATE):
        ...
        await cg.register_parented(s, config[CONF_A0001_Comp_02_ID])
        cg.add(A0001_Comp_02_component.set_baud_rate_select(s))
