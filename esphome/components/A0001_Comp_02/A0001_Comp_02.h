...
class A0001_Comp_02Component : public Component, public uart::UARTDevice {
//class A0001_Comp_02Component : public Component, public uart::UARTDevice,public gpio::GPIOBinaryOutput { //ALEX
#ifdef USE_SENSOR
