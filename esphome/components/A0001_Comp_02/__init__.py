...
A0001_Comp_02_ns = cg.esphome_ns.namespace("A0001_Comp_02")
A0001_Comp_02Component = A0001_Comp_02_ns.class_("A0001_Comp_02Component", cg.Component, uart.UARTDevice)

CONF_A0001_Comp_02_ID = "A0001_Comp_02_id"
...
CONFIG_SCHEMA = cv.Schema(
    {
        cv.GenerateID(): cv.declare_id(A0001_Comp_02Component),
...
CALIBRATION_ACTION_SCHEMA = maybe_simple_id(
    {
        cv.Required(CONF_ID): cv.use_id(A0001_Comp_02Component),
    }
)


# Actions
BluetoothPasswordSetAction = A0001_Comp_02_ns.class_(
