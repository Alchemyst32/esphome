...
static const char *const TAG = "A0001_Comp_02";
...
void A0001_Comp_02Component::restart_() { this->send_command_(CMD_RESTART, nullptr, 0); }

void A0001_Comp_02Component::query_parameters_() { this->send_command_(CMD_QUERY, nullptr, 0); }
void A0001_Comp_02Component::get_version_() { this->send_command_(CMD_VERSION, nullptr, 0); }
void A0001_Comp_02Component::get_mac_() {
  uint8_t cmd_value[2] = {0x01, 0x00};
  this->send_command_(CMD_MAC, cmd_value, 2);
}
void A0001_Comp_02Component::get_distance_resolution_() { this->send_command_(CMD_QUERY_DISTANCE_RESOLUTION, nullptr, 0); }

void A0001_Comp_02Component::get_light_control_() { this->send_command_(CMD_QUERY_LIGHT_CONTROL, nullptr, 0); }
...
#ifdef USE_SENSOR
void A0001_Comp_02Component::set_gate_move_sensor(int gate, sensor::Sensor *s) { this->gate_move_sensors_[gate] = s; }
void A0001_Comp_02Component::set_gate_still_sensor(int gate, sensor::Sensor *s) { this->gate_still_sensors_[gate] = s; }
#endif
