...
A0001_Comp_03_ns = cg.esphome_ns.namespace("A0001_Comp_03")
A0001_Comp_03Component = A0001_Comp_03_ns.class_("A0001_Comp_03Component", cg.Component, uart.UARTDevice)

CONF_A0001_Comp_03_ID = "A0001_Comp_03_id"
...
CONFIG_SCHEMA = cv.Schema(
    {
        cv.GenerateID(): cv.declare_id(A0001_Comp_03Component),
...
CALIBRATION_ACTION_SCHEMA = maybe_simple_id(
    {
        cv.Required(CONF_ID): cv.use_id(A0001_Comp_03Component),
    }
)


# Actions
BluetoothPasswordSetAction = A0001_Comp_03_ns.class_(
