...
static const char *const TAG = "A0001_Comp_03";
...
//  ESP_LOGI("Alex", "setup");  //ALEX -Informacion ///////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  ESP_LOGCONFIG(TAG, "Mac Address : %s", const_cast<char *>(this->mac_.c_str()));
  ESP_LOGCONFIG(TAG, "Firmware Version : %s", const_cast<char *>(this->version_.c_str()));
  ESP_LOGCONFIG(TAG, "A0001_Comp_03 setup complete.");
...
void A0001_Comp_03Component::set_Gpio_Config(){ //ALEX ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
void A0001_Comp_03Component::loop() {
...
// ANALIZA LAS TRAMAS DE DATOS RECIBIDAS ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void A0001_Comp_03Component::handle_periodic_data_(uint8_t *buffer, int len) {
  ...
  */
  ...
  if (this->target_binary_sensor_ != nullptr) {
   ...
   // ESP_LOGI("Alex", "Target 1 %i",target_state);  //ALEX -Informacion ///////////////////////////////////////////////////////////////////////////////////////////////////////////
  }
  ...
  if (this->still_target_binary_sensor_ != nullptr) {
   ...
   // ESP_LOGI("Alex", "Target 3 %i",target_state);  //ALEX -Informacion ///////////////////////////////////////////////////////////////////////////////////////////////////////////
  }
#endif
  /*
...
bool A0001_Comp_03Component::handle_ack_data_(uint8_t *buffer, int len) {
...
void A0001_Comp_03Component::readline_(int readch, uint8_t *buffer, int len) {
  static int pos = 0;
...
void A0001_Comp_03Component::set_config_mode_(bool enable) {
...
void A0001_Comp_03Component::set_bluetooth(bool enable) {
...
void A0001_Comp_03Component::set_distance_resolution(const std::string &state) {
...
void A0001_Comp_03Component::set_baud_rate(const std::string &state) {
...
void A0001_Comp_03Component::set_bluetooth_password(const std::string &password) {
...
void A0001_Comp_03Component::set_engineering_mode(bool enable) {
...
void A0001_Comp_03Component::factory_reset() {
...
void A0001_Comp_03Component::restart_() { this->send_command_(CMD_RESTART, nullptr, 0); }

void A0001_Comp_03Component::query_parameters_() { this->send_command_(CMD_QUERY, nullptr, 0); }
void A0001_Comp_03Component::get_version_() { this->send_command_(CMD_VERSION, nullptr, 0); }
void A0001_Comp_03Component::get_mac_() {
  uint8_t cmd_value[2] = {0x01, 0x00};
  this->send_command_(CMD_MAC, cmd_value, 2);
}
void A0001_Comp_03Component::get_distance_resolution_() { this->send_command_(CMD_QUERY_DISTANCE_RESOLUTION, nullptr, 0); }

void A0001_Comp_03Component::get_light_control_() { this->send_command_(CMD_QUERY_LIGHT_CONTROL, nullptr, 0); }

#ifdef USE_NUMBER
void A0001_Comp_03Component::set_max_distances_timeout() {
...
void A0001_Comp_03Component::set_gate_threshold(uint8_t gate) {
...
void A0001_Comp_03Component::set_gate_still_threshold_number(int gate, number::Number *n) {
  ESP_LOGI("Alex", "set_gate_still_threshold_number");  //ALEX -Informacion ///////////////////////////////////////////////////////////////////////////////////////////////////////////
  this->gate_still_threshold_numbers_[gate] = n;
}

void A0001_Comp_03Component::set_gate_move_threshold_number(int gate, number::Number *n) {
  ESP_LOGI("Alex", "set_gate_move_threshold_number");  //ALEX -Informacion ///////////////////////////////////////////////////////////////////////////////////////////////////////////
  this->gate_move_threshold_numbers_[gate] = n;
}
#endif

void A0001_Comp_03Component::set_light_out_control() {
...
#ifdef USE_SENSOR
void A0001_Comp_03Component::set_gate_move_sensor(int gate, sensor::Sensor *s) { this->gate_move_sensors_[gate] = s; }
void A0001_Comp_03Component::set_gate_still_sensor(int gate, sensor::Sensor *s) { this->gate_still_sensors_[gate] = s; }
#endif
