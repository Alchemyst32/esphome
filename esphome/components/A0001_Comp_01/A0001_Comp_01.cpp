...
static const char *const TAG = "A0001_Comp_01";

A0001_Comp_01Component::A0001_Comp_01Component() {}

void A0001_Comp_01Component::dump_config() {
  ESP_LOGCONFIG(TAG, "A0001_Comp_01:");
...
void A0001_Comp_01Component::send_command_(uint8_t command, const uint8_t *command_value, int command_value_len) {
...
bool A0001_Comp_01Component::handle_ack_data_(uint8_t *buffer, int len) {
...
void A0001_Comp_01Component::readline_(int readch, uint8_t *buffer, int len) {
  static int pos = 0;
...
void A0001_Comp_01Component::set_config_mode_(bool enable) {
  uint8_t cmd = enable ? CMD_ENABLE_CONF : CMD_DISABLE_CONF;
  uint8_t cmd_value[2] = {0x01, 0x00};
  this->send_command_(cmd, enable ? cmd_value : nullptr, 2);
}

void A0001_Comp_01Component::set_bluetooth(bool enable) {
  this->set_config_mode_(true);
...
void A0001_Comp_01Component::set_distance_resolution(const std::string &state) {
  this->set_config_mode_(true);
...
void A0001_Comp_01Component::set_baud_rate(const std::string &state) {
  this->set_config_mode_(true);
...
void A0001_Comp_01Component::set_bluetooth_password(const std::string &password) {
...
void A0001_Comp_01Component::set_engineering_mode(bool enable) {
  this->set_config_mode_(true);
...
void A0001_Comp_01Component::factory_reset() {
  this->set_config_mode_(true);
  this->send_command_(CMD_RESET, nullptr, 0);
  this->set_timeout(200, [this]() { this->restart_and_read_all_info(); });
}

void A0001_Comp_01Component::restart_() { this->send_command_(CMD_RESTART, nullptr, 0); }

void A0001_Comp_01Component::query_parameters_() { this->send_command_(CMD_QUERY, nullptr, 0); }
void A0001_Comp_01Component::get_version_() { this->send_command_(CMD_VERSION, nullptr, 0); }
void A0001_Comp_01Component::get_mac_() {
  uint8_t cmd_value[2] = {0x01, 0x00};
  this->send_command_(CMD_MAC, cmd_value, 2);
}
void A0001_Comp_01Component::get_distance_resolution_() { this->send_command_(CMD_QUERY_DISTANCE_RESOLUTION, nullptr, 0); }

void A0001_Comp_01Component::get_light_control_() { this->send_command_(CMD_QUERY_LIGHT_CONTROL, nullptr, 0); }

#ifdef USE_NUMBER
void A0001_Comp_01Component::set_max_distances_timeout() {
...
void A0001_Comp_01Component::set_gate_threshold(uint8_t gate) {
...
void A0001_Comp_01Component::set_gate_still_threshold_number(int gate, number::Number *n) {
  this->gate_still_threshold_numbers_[gate] = n;
}

void A0001_Comp_01Component::set_gate_move_threshold_number(int gate, number::Number *n) {
...
#ifdef USE_SENSOR
void A0001_Comp_01Component::set_gate_move_sensor(int gate, sensor::Sensor *s) { this->gate_move_sensors_[gate] = s; }
void A0001_Comp_01Component::set_gate_still_sensor(int gate, sensor::Sensor *s) { this->gate_still_sensors_[gate] = s; }
#endif
