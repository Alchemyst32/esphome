...
A0001_Comp_01_ns = cg.esphome_ns.namespace("A0001_Comp_01")
A0001_Comp_01Component = A0001_Comp_01_ns.class_("A0001_Comp_01Component", cg.Component, uart.UARTDevice)

CONF_A0001_Comp_01_ID = "A0001_Comp_01_id"
...
CONFIG_SCHEMA = cv.Schema(
    {
        cv.GenerateID(): cv.declare_id(A0001_Comp_01Component),
...
CALIBRATION_ACTION_SCHEMA = maybe_simple_id(
    {
        cv.Required(CONF_ID): cv.use_id(A0001_Comp_01Component),
    }
)


# Actions
BluetoothPasswordSetAction = A0001_Comp_01_ns.class_(
